                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${tracks.map((t) => t.album).toSet().length} álbum${tracks.map((t) => t.album).toSet().length == 1 ? '' : 's'} · ${tracks.length} música${tracks.length == 1 ? '' : 's'} · ${_formatDuration(tracks.fold(0, (sum, t) => sum + t.durationMs))}',
