...
public class MainActivity extends AudioServiceActivity {
    ...
    public void configureFlutterEngine(FlutterEngine flutterEngine) {
        ...
        new MethodChannel(
                ...
                SAF_CHANNEL).setMethodCallHandler((call, result) -> {
                    ...
                    if (call.method.equals("openFolderPicker")) {
                        ...
                        try {
                            ...
                            if (folderDoc == null) {
                                result.error("FOLDER_NOT_FOUND", "Pasta não encontrada: " + folderUriString, null);
                                return;
                            }
                            ...
                            if (targetDoc == null) {
                                ...
                                if (targetFileName.endsWith(".m4a"))
                                    mimeType = "audio/mp4";
                                else if (targetFileName.endsWith(".mp3"))
                                    mimeType = "audio/mpeg";
